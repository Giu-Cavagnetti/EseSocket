...
public class BetServer {
    ...
    public void run() {
        while (accept) {
            try {
                ...
                // riceve la scommessa
                // (nel formato "numcavallo puntata") e la inserisce nella lista scommesse
                String line = in.readLine();
                String[] parts = line.split(" ");
                int numCavallo = Integer.parseInt(parts[0]);
                long puntata = Long.parseLong(parts[1]);
    ...
    public static void main (String[] args){
        ...
        try{
            ...
            Thread.sleep(120000);
            server.resetServer();
        } catch (InterruptedException | UnknownHostException ie) { System.out.println(ie); }
    }
